...
public class BlocklyActivityHelper {
    ...
    public void requestCodeGeneration(
        ...
        mCodeGeneratorManager.requestCodeGeneration(new CodeGenerationRequest(serialized.toString(), codeGenerationCallback, codeGeneratorLanguage, blockDefinitionsJsonPaths, generatorsJsPaths));
        try {
            serialized.close();
