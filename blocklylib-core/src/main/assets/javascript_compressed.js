...
Blockly.JavaScript['arblock_mover'] = function(block) {
  var dropdown_drop_mover = block.getFieldValue('drop_mover');
  var number_input_numeric_movimiento = block.getFieldValue('input_numeric_movimiento');
  //var value_value_mover = Blockly.JavaScript.valueToCode(block, 'value_mover', Blockly.JavaScript.ORDER_ATOMIC);
  var code = 'mover ' + dropdown_drop_mover +' ' + number_input_numeric_movimiento +' \n';
  return code;
};